$(document).ready(function() {
    ...
    $('.itemList').on('click', '.cartBtn', function() {

        //Remove message when a favourite item is added
        $('.cart_itemList .emptyMessage').remove()
        ...
        // append
        $('.cart_itemList').append(tempt3)


        //declare tags
        var item_data = '<i class="material-icons delete">delete</i>'

        //removeElements
        $('.cart_itemList li[data-keyword=' + tempt + '] div div .cartBtn').remove()
        $('.cart_itemList li[data-keyword=' + tempt + '] div div .favorite').remove()
        $('.cart_itemList li[data-keyword=' + tempt + '] div div .rating').remove()
        $('.cart_itemList li[data-keyword=' + tempt + '] div div').append(item_data)
